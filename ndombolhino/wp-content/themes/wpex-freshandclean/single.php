		...
		<div id="post" class="col span_8 clr">
			...
			<header id="post-heading">
				...
				<ul class="meta clr">
					...
					if( comments_open() ) { ?>
						<li class="comment-scroll"><i class="fa fa-comments"></i> <?php comments_popup_link(__('0 Comments', 'wpex'), __('1 Comment', 'wpex'), __('% Comments', 'wpex'), 'comments-link' ); ?></li>
					<?php } ?>
				</ul>
			</header><!-- #post-title -->
			...
			<div id="post-pagination" class="clr">
				<div class="post-prev"><?php next_post_link('%link', '<span class="fa fa-arrow-left"></span>' . __('Previous','wpex'), false); ?></div> 
				<div class="post-next"><?php previous_post_link('%link', __('Next','wpex') . '<span class="fa fa-arrow-right"></span>', false); ?></div>
			</div><!-- #post-pagination -->
